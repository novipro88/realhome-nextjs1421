...
const PostDisplay = ({ data, handleAddFriend }) => {
  ...
  const isDisplayAddFriend =
    user?.friends?.includes(data?.userId?._id) ||
  ...
  return (
    <div className="bg-white p-4 my-6">
      <div className="flex gap-3 items-center justify-between">
        ...
        {!isDisplayAddFriend && (
          <div
            className="bg-white shadow-md p-2 rounded-full flex justify-center items-center cursor-pointer hover:bg-blue-700"
            onClick={() => handleAddFriend(data?.userId?._id)}
          >
            <Image
      ...
      <div className="py-1 flex justify-between gap-3">
        ...
        >
          ...
          <p className={currentUserLiked && "text-blue-800 font-semibold"}>
            Like
          </p>
        </div>
                  ...
                  <div className="flex gap-3 items-center">
                    ...
                    <div className="flex flex-col">
                      ...
                      <p className="text-xs -mt-1">
                        {comment?.userId?.occupation}
                      </p>
                    </div>
                  </div>
                  <div className="text-sm py-1 px-2">{comment.description}</div>
                </div>
              );
            })}
          </div>
